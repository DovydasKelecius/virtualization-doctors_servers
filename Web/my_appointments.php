...
$patient = $pdo->query("SELECT first_name, last_name FROM patients WHERE id = $patient_id")->fetch(PDO::FETCH_ASSOC);

$list = $pdo->query(
    "SELECT a.id, d.specialization, a.appointment_date, a.comment, d.first_name AS doctor_first_name, d.last_name AS doctor_last_name
    FROM appointments a
...
<body>
    <div class="container">
        ...
        <h3>Pacientas: <?= $patient["first_name"] ?> <?= $patient["last_name"] ?></h3>
